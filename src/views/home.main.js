...
import { Grid, Button, Toolbar, Typography, Box, Link } from '@material-ui/core'
...
const useStyleLink = makeStyles(theme => ({
  deco: {
    textDecoration: 'unset', margin: '0 1em', color: '#fff',
  },
  deco1: {
    textDecoration: 'unset', margin: '0 2em', color: '#fff',
  }
})) 
